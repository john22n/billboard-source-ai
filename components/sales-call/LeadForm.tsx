                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
                    <FieldInput
                      ...
                      hasValidationError={validationErrors.includes(
                        'Company Name',
                      )}
                    />
            ...
            <div className="flex-1 bg-gray-300 border-2 border-black shadow-sm shadow-black rounded-lg p-2.5 sm:p-3.5">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <Label className="text-sm sm:text-md font-bold whitespace-nowrap">
                    Ballpark:
                  </Label>
                  <BallparkInput />
                </div>
                ...
                <button
                  ...
                  className={`inline-block border-2 ${
                    activeMarketIndex === 0
                      ...
                      : 'bg-gray-300 text-gray-400 border-t-0 rounded-b-sm'
            ...
            <button
              ...
              className={`inline-block border-2 ${
                activeContactIndex === 0
                  ...
                  : 'bg-white text-gray-400 border-b-0 rounded-t-md'
